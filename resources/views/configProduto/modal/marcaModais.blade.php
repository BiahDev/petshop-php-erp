                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Nome da Marca" name="nome">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Novo nome da Marca" name="nome">
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- REMOVER UMA MARCA -->
<div class="col-md-4">
  <div class="modal fade" id="excluirModalMarca" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
