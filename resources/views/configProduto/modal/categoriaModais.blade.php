                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" name="categoria"
                                    placeholder="Novo nome da categoria" id="categoriaEditar">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <input type="hidden" name="id" id="categoriaIdEditar">
                    <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Fechar</button>
...
<div class="col-md-4">
    <div class="modal fade" id="excluirModalCategoria" tabindex="-1" role="dialog" aria-labelledby="modal-notification"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="py-3 text-center">
                        ...
                        <p>Você realmente deseja excluir essa <strong>Categoria</strong>? <br> Essa ação é
                            irreversível
                        </p>
                    </div>
                </div>
                <div class="modal-footer">
                    <form action="{{route('excluirCategoria')}}" method="post">
                        @csrf
                        @method('DELETE')
