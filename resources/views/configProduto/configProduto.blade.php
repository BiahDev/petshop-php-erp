            ...
            <div class="card-header pb-0">
                <div class="row">
                    ...
                    <div class="col-7 text-end">
                        <button type="button" class="btn btn-sm bg-gradient-primary mb-3" data-bs-toggle="modal"
                            data-bs-target="#novaModalCategoria">
        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                <div class="row">
                    ...
                    <div class="col-7 text-end">
                        <button type="button" class="btn btn-sm bg-gradient-primary mb-3" data-bs-toggle="modal"
                            data-bs-target="#novaModalSubCategoria">
