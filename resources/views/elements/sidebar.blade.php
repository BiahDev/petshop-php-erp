<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0">
      ...
      <span class="ms-1 font-weight-bold">Petshop</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="/configproduto">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa fa-cog text-primary text-sm opacity-10"></i>
            
          </div>
          <span class="nav-link-text ms-1">Configuração do Produto</span>
        </a>
      </li>
      <li class="nav-item">
    ...
    <div class="card card-plain shadow-none" id="sidenavCard">
      <div class="card-body text-center w-100">
        <div class="docs-info">
          ...
          <p class="text-xs font-weight-bold mb-0">Olhe a Documentação</p>
        </div>
      </div>
    </div>
    <a href="" target="_blank" class="btn btn-dark btn-sm w-100 mb-3">Documentação</a>
    <a class="btn btn-primary btn-sm mb-0 w-100" href="" type="button">GitHub</a>
  </div>
</aside>
